...
echo
echo Response
curl --fail --silent --show-error -X GET "https://api.authy.com/onetouch/$AUTHY_API_FORMAT/approval_requests/$1?api_key=$AUTHY_API_KEY" | underscore print --outfmt pretty
echo
