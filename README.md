...
1. If you are using macOS or Linux, you might want to install [underscore-cli](https://www.npmjs.com/package/underscore-cli) for simple pretty print of the JSON API response. Follow the link [here](https://github.com/ddopson/underscore-cli#installing-underscore-cli) for detailed installation instructions. API responses are piped into underscore-cli for pretty print of the JSON payload.
